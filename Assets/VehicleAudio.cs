...
public class VehicleAudio : MonoBehaviour
{
    ...
    public GameObject Vehicle; // Reference to car we are controlling
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, Vehicle.GetComponent<Vehicle>().currentEngineRPM);
            ...
            else
            {
                ...
                float accFade = Mathf.Abs(Vehicle.GetComponent<Vehicle>().wheelThrottle);
                float decFade = 1 - accFade;

                // get the high fade value based on the cars revs
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, Vehicle.GetComponent<Vehicle>().currentEngineRPM);
